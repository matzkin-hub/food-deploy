...
# docker build -t matzkin_food_management_app .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name matzkin_food_management_app matzkin_food_management_app
